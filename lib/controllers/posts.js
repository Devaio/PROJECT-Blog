...
var Posts = (function (_super) {
    ...
    Posts.prototype.setPostLocals = function (post, res) {
    ...
    Posts.prototype.createTagList = function (newPostTags) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        // Create Tag List
                        _a = body;
                        return [4 /*yield*/, this.createTagList(body.tags)];
                    case 1:
                        // Create Tag List
                        _a.tags = _b.sent();
