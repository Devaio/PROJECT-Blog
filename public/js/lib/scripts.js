...
},{"./controllers/admin/adminAddPost":4,"./controllers/admin/adminDashboard":5,"./controllers/admin/adminLogin":6,"./controllers/admin/adminUpdatePost":7,"./controllers/main/about":8,"./controllers/main/home":9,"./controllers/main/post":10,"./controllers/main/tag":11,"./directives/nav":12,"./factories/post-tag":13,"./routes":14,"./services/authService":15,"ng-file-upload":2}],4:[function(require,module,exports){
angular.module('BlogApp').controller('adminAddPost', [
  '$scope', '$location', '$http', '$timeout', 'authService', 'Upload', function($scope, $location, $http, $timeout, authService, Upload) {
    ...
    $scope.submit = function() {
      ...
      return uploader.then(function(returnData) {
        return returnData.data.data.forEach(function(file, index) {
          return $scope.files[index].url = file.url;
        });
      });
    };
...
angular.module('BlogApp').controller('adminUpdatePost', [
  '$scope', '$location', '$http', '$timeout', 'authService', '$stateParams', 'postTagFactory', function($scope, $location, $http, $timeout, authService, $stateParams, postTagFactory) {
    $scope.navheight = 'small';
    $scope.loading = false;
    ...
    return authService(function(stuff) {
      ...
      return $scope.updatePost = function() {
        var _ref, _ref1;
        console.log($scope.post);
        if ((_ref = $scope.post) != null ? (_ref1 = _ref.content) != null ? _ref1.length : void 0 : void 0) {
          $scope.loading = true;
          return $scope.post.createdAt = $scope.post.createdAt.getTime();
        }
      };
    });
  }
